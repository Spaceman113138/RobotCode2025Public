...
from vision_types import (CameraPoseObservation, FiducialImageObservation,
                          FiducialPoseObservation, TagAngleObservation)
...
def apriltag_worker(
    ...
    while True:
        ...
        tag_angle_observations = [tag_angle_calculator.calc_tag_angles(
            x, config) for x in image_observations if x.tag_id != DEMO_ID]
        ...
        q_out.put((timestamp, image_observations, camera_pose_observation, tag_angle_observations, demo_pose_observation))
